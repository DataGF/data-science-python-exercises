...
The code bellow simulates the birthday problem for a class. 

Right now the code simulates a class with only 10 people that get random birthdays, and the probability that those 2 people have the same birthday is low.

Change the number 10 to a higher number of your choosing where it says #Change This Number and run the code.
